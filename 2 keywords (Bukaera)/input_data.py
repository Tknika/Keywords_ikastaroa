...
answer = {
   ...
   # "request_contacto" : "Los datos de contacto del centro son: Teléfono: XXX XXX XXX. Email: xxxxxxx@gmail.com ",
    "request_telefono": "El número de teléfono del centro es: 943 01 01 01",
    "request_email": "El email del centro es secretaria@xxxx.eus",
    "request_direccion": "La dirección del centro es: XXXXXXXX",

    "request_oferta": "El centro tiene una gran oferta de formaciones para realizar. Puedes informarte sobre ellas aquí: xxx (URL)",
    "request_inscripcion": "¿Qué fecha de inscripción deseas saber. Las fechas de pre-matricula o de matrícula?",
